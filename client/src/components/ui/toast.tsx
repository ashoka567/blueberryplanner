...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 right-0 z-[9999] flex max-h-screen flex-col-reverse p-2 w-auto",
      className
    )}
    {...props}
  />
